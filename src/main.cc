...
//            std::cout << ir << " " << ig << " " << ib << "\n";
            ...
            colour.rgbRed = (unsigned char)(255.99*col[0]);
            colour.rgbGreen = (unsigned char)(255.99*col[1]);
            colour.rgbBlue = (unsigned char)(255.99*col[2]);
            FreeImage_SetPixelColor(image, (unsigned int)i, (unsigned int)j, &colour);
        }
    }
